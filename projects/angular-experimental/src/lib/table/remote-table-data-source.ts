import { SbbxTableDataSource } from './table.component';
...
export abstract class SbbxRemoteTableDataSource<T, F extends SbbTableFilter | string>
  implements SbbxTableDataSource<T, F>
{
